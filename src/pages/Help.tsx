          ...
          <CardContent className="p-6 flex flex-col sm:flex-row items-start sm:items-center gap-5">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-muted-foreground mt-1">
                Notre équipe vous répond sous <strong>24h ouvrées</strong>, du lundi au vendredi. Décrivez votre problème avec le plus de détails possible pour une aide rapide.
              </p>
            </div>
